...
// When the blue box is clicked set the hipster paragraph to 
//have white text with a blue background.  All other 
...
// When the red box is clicked set the list items toggle red 
//background and white text on and off

jQuery("#redBox").on("click",function(){
    jQuery("li").toggleClass("redForm");
});

// When any of the boxes are clicked, add a 6px solid black 
//bottom border
